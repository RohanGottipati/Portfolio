  ...
  "group/button relative isolate inline-flex overflow-hidden rounded-xl text-sm font-medium transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[linear-gradient(120deg,transparent_18%,rgba(255,255,255,0.16)_48%,transparent_78%)] before:translate-x-[-150%] before:opacity-0 before:transition-[transform,opacity] before:duration-700 before:ease-out hover:before:translate-x-[150%] hover:before:opacity-100 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        terminalLink:
          "inline-flex min-h-11 items-center justify-center gap-2 border border-white/10 bg-[linear-gradient(180deg,rgba(18,18,18,0.98),rgba(9,9,9,0.98))] px-4 text-foreground shadow-[0_14px_34px_-24px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.08)] hover:-translate-y-1 hover:border-primary/65 hover:bg-[linear-gradient(180deg,rgba(28,28,28,1),rgba(12,12,12,1))] hover:shadow-[0_24px_44px_-22px_rgba(238,238,238,0.32),0_18px_40px_-30px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.12)] active:translate-y-0",
        terminalInline:
        ...
        terminalSurface:
          "border border-white/10 bg-[linear-gradient(180deg,rgba(16,16,16,0.98),rgba(10,10,10,0.98))] text-foreground shadow-[0_18px_38px_-30px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.06)] hover:-translate-y-1 hover:border-primary/65 hover:bg-[linear-gradient(180deg,rgba(24,24,24,1),rgba(12,12,12,1))] hover:shadow-[0_26px_54px_-28px_rgba(238,238,238,0.28),0_18px_34px_-26px_rgba(0,0,0,0.98),inset_0_1px_0_rgba(255,255,255,0.1)] active:translate-y-0",
        dashboardRow:
          "border border-white/10 bg-[linear-gradient(180deg,rgba(18,18,18,0.95),rgba(10,10,10,0.95))] text-muted-foreground shadow-[0_16px_34px_-30px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.06)] hover:-translate-y-1 hover:border-primary/55 hover:bg-[linear-gradient(180deg,rgba(26,26,26,0.98),rgba(13,13,13,0.98))] hover:text-foreground hover:shadow-[0_24px_48px_-24px_rgba(238,238,238,0.24),0_12px_30px_-24px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.1)] active:translate-y-0",
        terminalIcon:
          "inline-flex items-center justify-center rounded-xl border border-white/10 bg-[linear-gradient(180deg,rgba(18,18,18,0.98),rgba(10,10,10,0.98))] text-muted-foreground shadow-[0_14px_30px_-22px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.08)] hover:-translate-y-1 hover:border-primary/65 hover:bg-[linear-gradient(180deg,rgba(28,28,28,0.98),rgba(14,14,14,0.98))] hover:text-foreground hover:shadow-[0_22px_42px_-18px_rgba(238,238,238,0.28),0_16px_32px_-24px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.12)] active:translate-y-0",
        commandMenu:
